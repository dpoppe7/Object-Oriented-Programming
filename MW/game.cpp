...
namespace Minesweeper{
    ...
    void Game::setTotalCells(Board gameBoard){
        totalCells = gameBoard.boardSize.row * gameBoard.boardSize.col - getNumMines();
    }

    int Game::getTotalCells(){
        return totalCells;
    }
